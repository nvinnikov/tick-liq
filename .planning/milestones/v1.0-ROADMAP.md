...
Plans:
- [x] 07-01-PLAN.md — teloxide bot module + command router + operator_pause schema + watch loop spawn
- [x] 07-02-PLAN.md — Rebalance proposal flow: send message, await /approve with timeout, skip+log on timeout
- [x] 07-03-PLAN.md — /status, /pause, /resume, /report command implementations + operator_pause gate in watch loop
